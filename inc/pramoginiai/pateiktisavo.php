...
<div class="div-klau">
  <span>Kiek kartų per savaitę norėtumėte šokti?</span>
  <fieldset class="klau">
...
<div class="div-klau">
  <span>Nurodykite Jums tinkamas savaitės dienas ir užsiėmimo pradžios laikus:</span>
</div>

<fieldset class="sav-d" id="fieldset-top">
  <div>Pirmadieniais:</div>
  <div><div>18 val.</div><div><input id="I-2" style="" type="radio" name="pirmad" value="18" /></div></div>
  <div><div>19 val.</div><div><input id="I-3" style="" type="radio" name="pirmad" value="19" /></div></div>
  <div><div>20 val.</div><div><input id="I-4" style="" type="radio" name="pirmad" value="20" /></div></div>
  <div><div>Iki 18 val.</div><div><input id="I-1" style="" type="radio" name="pirmad" value="17" /></div></div>
</fieldset>
...
<fieldset class="sav-d">
  <div style="margin: 0 0 15px 0;">Sekmadieniais:</div>
...
<div class="div-klau">
  <span>Norite gauti informaciją apie naujus pasiūlymus šokti?</span>
</div>
